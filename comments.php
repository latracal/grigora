...
'comment_field' => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun' ) .
        '</label><br /><textarea id="comment" rows="5" cols="50" name="comment" aria-required="true"></textarea></p>',
//Define Fields
'fields' => array(
//Author field
'author' => '<p class="comment-form-author"><label>Name</Name><br /><input id="author" name="author"
            aria-required="true" placeholder=""></input></p>',
//Email Field
'email' => '<p class="comment-form-email"><label>Email</label><br /><input id="email" name="email"
        placeholder=""></input></p>',
//URL Field
