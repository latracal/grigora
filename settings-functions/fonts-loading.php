...
if (grigora_get_option("typography") && function_exists('google_fonts')){
    ...
    function grigora_add_google_fonts() {
        $safewebfonts = array("Arial", "Times New Roman", "Times", "Courier New", "Courier", "Verdana", "Georgia", "Palatino", "Garamond", "Bookman", "Tahoma", "Trebuchet MS", "Arial Black", "Impact", "Comic Sans MS");
        $mods = array();
