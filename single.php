...
<div class="container">
    ...
    <section class="post-content">
                ...
                <?php if( get_theme_mod( 'grg_blog_single_social_share' ) )
        {
            ?>
                <span class="social">
                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode(get_the_title()); ?>&url=<?php echo urlencode(the_permalink()); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
